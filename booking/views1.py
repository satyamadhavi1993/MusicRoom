...
def reservations(request):
    ...
    return render(request, 'reservations.html', {'upcoming_reservations': upcoming_reservations, 'last_30_reservations': last_30_reservations})
...
def reserve(request):
    if request.method == "POST":
        ...
        return HttpResponse('Thank you for booking')
    print('GET reserve')
